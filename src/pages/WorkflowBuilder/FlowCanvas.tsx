...
import FindNode from 'components/node/findNode';
import MapNode from 'components/node/mapNode';
import ReduceNode from 'components/node/reduceNode'
...
const FlowCanvas = () => {
	...
	const nodeTypes = useMemo(() => ({ FileNode, FilterNode, FindNode, MapNode, ReduceNode }), []);
